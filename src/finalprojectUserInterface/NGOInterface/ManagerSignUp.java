...
public class ManagerSignUp extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(name_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, 216, -1));

        name_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        name_lbl.setText("Name:");
        jPanel1.add(name_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, -1, -1));

        uname_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        uname_lbl.setText("Username:");
        jPanel1.add(uname_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, -1, -1));
        jPanel1.add(uname_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, 216, -1));

        pwd_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        pwd_lbl.setText("Password:");
        jPanel1.add(pwd_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, -1, -1));
        jPanel1.add(pass_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 216, 27));

        address_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        address_lbl.setText("Address:");
        jPanel1.add(address_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, -1, -1));
        jPanel1.add(add_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 70, 216, 27));

        city_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        city_lbl.setText("City:");
        jPanel1.add(city_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 130, -1, -1));
        jPanel1.add(city_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 120, 216, 27));

        state_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        state_lbl.setText("State:");
        jPanel1.add(state_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, -1, -1));
        jPanel1.add(state_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 170, 216, 27));

        zip_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        zip_lbl.setText("Zip Code:");
        jPanel1.add(zip_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, -1, -1));
        jPanel1.add(zip_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 220, 220, 30));
        ...
        jPanel1.add(back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 87, -1));

        ngolist.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {  }));
        jPanel1.add(ngolist, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 216, -1));
        ...
        jPanel1.add(signup_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 350, 87, -1));

        depart_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        depart_lbl.setText("Department:");
        jPanel1.add(depart_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, -1, 20));

        ngo_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ngo_lbl.setText("NGO Name:");
        jPanel1.add(ngo_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, -1, -1));
        jPanel1.add(depart_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 240, 216, 27));
